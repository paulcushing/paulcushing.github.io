...
It happened enough times finally that I decided to build my own. Initially, I hard-coded a date I found useful. I hit that page from time to time to be reminded of how long it's been. 
...
```
I used Tailwind CSS for the styles and came up with something I think looks nice.
